...
#### 13.1.2. 376.摆动序列(todo)

#### 13.1.3. 53.最大子数组和(todo)
#### 13.1.4. 300.最长递增子序列
#### 13.1.5. 354.俄罗斯套娃信封问题
#### 13.1.6. 343.整数拆分(剑指offer131.剪绳子；剑指offer132.剪绳子II)
#### 13.1.7. 763.划分字母区间
...
#### 14.4.1. 53.最大子数组和
#### 14.4.2. 300.最长递增子序列
#### 14.4.3. 673.最长递增子序列的个数
#### 14.4.4. 354.俄罗斯套娃信封问题
#### 14.4.5. 718.最长重复子数组
#### 14.4.6. 1143.最长公共子序列
#### 14.4.7. 1035.不相交的线
#### 14.4.8. 72.编辑距离
#### 14.4.9. 115.不同的子序列
#### 14.4.10. 392.判断子序列(todo)
#### 14.4.11. 583.两个字符串的删除操作(todo)
#### 14.4.12. 712.两个字符串的最小ASCII删除和(todo)
#### 14.4.13. 647.回文子串
#### 14.4.14. 5.最长回文子串
#### 14.4.15. 516.最长回文子序列
#### 14.4.16. 1312.让字符串成为回文串的最少插入次数
#### 14.4.17. 376.摆动序列
