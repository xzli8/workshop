...
#### 1.3.3.1. 268.丢失的数字
#### 1.3.3.2. 389.找不同
#### 1.3.3.3. 136.只出现一次的数字
#### 1.3.3.4. 137.只出现一次的数字II
#### 1.3.3.5. 260.只出现一次的数字III
#### 1.3.3.6. 540.有序数组中的单一元素(用异或解题时间复杂度无法满足，因为没有利用数组有序的条件)

## 1.4. 质数
#### 1.4.1. 204.计数质数(厄拉多塞筛法)

## 1.5. 随机数
#### 1.5.1. 470.用Rand7()实现Rand10()，(等概率随机数：放大等概率随机数 + 拒绝采样)
#### 1.5.2. 380.O(1)时间插入、删除和获取随机元素
#### 1.5.3. 710.黑名单中的随机数
#### 1.5.4. 382.链表随机节点
#### 1.5.5. 398.随机数索引
...
## 11.4. 需要挖掘单调性
#### 11.4.1. 287.寻找重复数
#### 11.4.2. 540.有序数组中的单一元素
#### 11.4.3. 410.分割数组的最大值
#### 11.4.4. 875.爱吃香蕉的珂珂
#### 11.4.5. 1095.山脉数组中查找目标值
#### 11.4.6. 300.最长递增子序列
#### 11.4.7. 354.俄罗斯套娃信封问题
#### 11.4.8. 528.按权重随机选择
#### 11.4.9. 1044.最长重复子串
